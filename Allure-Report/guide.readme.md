...
<pre> i. Node JS – [https://nodejs.org/en/download/prebuilt-installer](https://nodejs.org/en/download/prebuilt-installer)
<pre> ii. cmd → `node --version`
<pre> iii. cmd → `npm -g i allure-commandline`
